...
<section class="hero">
	...
	<div id="carousel">
			<div class="item splash"><img class="" src="<?php print $directory;?>/images/theme/bg-top-images/top-bg-1.jpg" alt=""></div>
			<div class="item splash"><img class="" src="<?php print $directory;?>/images/theme/bg-top-images/top-bg-2.jpg" alt=""></div>
			<div class="item splash"><img class="" src="<?php print $directory;?>/images/theme/bg-top-images/top-bg-3.jpg" alt=""></div>
			<div class="item splash"><img class="" src="<?php print $directory;?>/images/theme/bg-top-images/top-bg-4.jpg" alt=""></div>
	</div>
